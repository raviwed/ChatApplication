import { View, Text, SafeAreaView, ImageBackground, TextInput, Image, TouchableOpacity, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard } from "react-native"
        ...
        <SafeAreaView style={Styles.chatContainer} >
            <ImageBackground style={Styles.image} source={require('./Assets/socialmedia.jpg')} resizeMode="cover"  >
                <View style={Styles.navbar} >
                    ...
                    <View style={Styles.videoCallDotContainer} >
                ...
                <View style={Styles.inputContainer} >
                    <View style={Styles.emojismileContainer}>
